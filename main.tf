resource "aws_security_group" "default" {
  ...
  ingress {
    ...
    to_port         = 80
    protocol        = "tcp"
    cidr_blocks     = ["190.210.146.233/32","200.41.179.202/32", "190.216.95.114/32", "200.13.235.58/32", "190.69.154.37/32","34.230.211.143","54.208.10.185", "54.85.91.226","44.197.144.69"]
    prefix_list_ids = []
  }
